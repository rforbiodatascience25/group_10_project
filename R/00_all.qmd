...
if (!fs::file_exists(raw_file)) {
  RKaggle::get_dataset("adilimadeddinehosni/multi-resistance-antibiotic-susceptibility") %>% 
    write_csv(raw_file)
}
```
...
#### Fourth model: Which is the main contributor for infection frequency?
